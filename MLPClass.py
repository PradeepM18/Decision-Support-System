...
def MLPModel(x,y):
    ...
    result_mlp=model.predict(x_test)
    ...
    results = confusion_matrix(y, result_mlp)
    print('Confusion Matrix :')
    print(results)

    print('Accuracy Score :',accuracy_score(y,result_mlp))

    print('Report :' )
    print (classification_report(y,result_mlp))
    Roc_curve(y,result_mlp,len(list(set(y))))
...
print("\nTerm Frequency:")
MLPModel(term_frequency,y)

print("\ntf_idf:")
MLPModel(tf_idf_score,y)
