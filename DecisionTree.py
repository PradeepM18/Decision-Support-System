...
def Dtree(x,y):
    ...
    result_tree=model.predict(x_test)
    print(result_tree)
    ...
    results = confusion_matrix(y_test, result_tree)
    print('Confusion Matrix :')
    print(results)

    print('Accuracy Score :',accuracy_score(y_test,result_tree))

    print('Report :' )
    print (classification_report(y_test,result_tree))

    Roc_curve(y_test,result_tree,len(set(y)))
...
print("\nTerm Frequency:")
Dtree(term_frequency,y)

print("\ntf_idf:")
Dtree(tf_idf_score,y)
