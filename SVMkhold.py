...
def SVMModel(x,y):
    ...
    results = confusion_matrix(y_test, result_svm)
    print('Confusion Matrix :')
    print(results)

    print('Accuracy Score :',accuracy_score(y_test,result_svm))

    print('Report :' )
    print (classification_report(y_test,result_svm))

    Roc_curve(y_test,result_svm,len(set(y)))
...
print("\nTerm Frequency:")
SVMModel(term_frequency,y)

print("\ntf_idf:")
SVMModel(tf_idf_score,y)
